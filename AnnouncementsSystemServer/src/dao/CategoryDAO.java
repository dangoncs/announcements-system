...
public class CategoryDAO {
    ...
    public static boolean exists(String categoryId) throws SQLException {
    ...
    public static List<Category> readAll(String userId) throws SQLException {
        ...
        try (Connection conn = Database.connect(); PreparedStatement ps = conn.prepareStatement(sql); ResultSet rs = ps.executeQuery()) {
